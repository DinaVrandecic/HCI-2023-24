...
const CustomerReviews: React.FC = () => (
  <div className="flex flex-col items-center mt-10 py-10 bg-peach1">
    ...
    <h2 className="font-serif text-2xl font-bold text-[#25669C] mb-7">
      CUSTOMER REVIEWS
    </h2>
    <div className="flex flex-col sm:flex-row items-center space-y-5 sm:space-y-0 sm:space-x-5 justify-center">
      <div className="text-center">
        <div className="review-content flex flex-col items-center">
          ...
          <div className="text-and-stars w-full text-[#25669C]">
            <p className="font-serif font-bold">SIOBHAN ROY</p>
            <p className="font-serif italic mt-5 mb-2">
      ...
      <div className="text-center">
        <div className="review-content flex flex-col items-center">
          ...
          <div className="text-and-stars w-full text-[#25669C]">
            <p className="font-serif font-bold">NADIA MORALES</p>
            <p className="font-serif italic mt-5 mb-2">
      ...
      <div className="text-center">
        <div className="review-content flex flex-col items-center">
          ...
          <div className="text-and-stars w-full text-[#25669C]">
            <p className="font-serif font-bold">PAMELA BEESLY-HALPERT</p>
            <p className="font-serif italic mt-5 mb-2">
